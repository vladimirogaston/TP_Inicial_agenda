...
public class VistaAbmLocalidades extends JFrame {
	...
	public VistaAbmLocalidades() {
		...
		panel.setBorder(new TitledBorder(null, "Formulario de localidades", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_1.setBorder(new TitledBorder(null, "Localidades registradas", TitledBorder.LEADING, TitledBorder.TOP, null, null));
