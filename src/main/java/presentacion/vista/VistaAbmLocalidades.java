...
public class VistaAbmLocalidades extends JDialog {
	...
	public Object [] displayForm(String [] provincias) {
		...
		if(provincias != null) {
			...
			fields.add(field);
			fields.add(comboBox);
			int result = JOptionPane.showConfirmDialog(null, fields, "Nueva Localidad", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
			switch (result) {
	...
	public Object [] displayForm(String [] provincias, String loc, String provincia) {
		...
		if(provincias != null) {
			...
			field.setText(loc);
			int result = JOptionPane.showConfirmDialog(null, fields, "Editar localidad", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
			switch (result) {
			    case JOptionPane.OK_OPTION:
			        break;
			}
