...
public class VistaAbmProvincia extends JDialog {

	private static VistaAbmProvincia vista;
	...
	public static VistaAbmProvincia getInstance() {
		if (vista == null)
			vista = new VistaAbmProvincia();
		return vista;
	}

	public VistaAbmProvincia() {
